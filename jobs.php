...
<body onload="logoBeat()" style="font-family: 'Libre Baskerville', serif;">
  ...
  <!-- Main Container -->
  <div class="container-fluid" style=" background-color: #212A31; background-position: center; background-size: cover; background-repeat: no-repeat; background-attachment: fixed;">
      ...
      <div style="width: 100%" class="row">
        <div class="col-md-9">
          ...
          <div class="container" style="padding-left:50px; padding-top:50px; padding-bottom:50px;">
            ...
            ?>
                <h3 style="font-family: 'Libre Baskerville', cursive; font-family: 'Libre Baskerville', serif; color: #d3d9d4; padding-left:4px;"> Total Job Posts Available: <?php echo $numberofposts; ?> </h3>
            <?php }
            } ?>
        ...
        <div class="container row">
          ...
          while(  $row=$result->fetch_assoc()){
                ...
                $status=$row['status'];
          ?>
          <div class="col-md-10" style="margin: 10px; background: rgba(46,57,68, 0.8);padding: 1px;box-shadow: 0px 0px 5px #2e3944">
            <a href="post-details.php?post_id=<?php echo $pid; ?>"><h1 style="color: #d3d9d4"><?php echo $jobtitle;?></h1></a>
            ...
            <a href="applyJob.php?id=<?php echo $pid;?>" class="pull-right"style="color: #748d92" ><h3>Apply</h3></a>
          </div>                      
          <?php }
          }else{
